...
import useSearchFormSubmit from "@/hooks/useSearchForm";
...
const SearchBar: React.FC<SearchBarProps> = ({ isSearchOpen, setIsSearchOpen }) => {
  ...
  const categories: string[] = [
    "electronics", "fashion", "beauty", "jewelry"
  ];
  // Next to do the style of the compononent
  return (
    <>
      <section
